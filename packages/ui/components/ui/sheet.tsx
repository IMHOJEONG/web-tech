  ...
  return (
    <SheetPrimitive.Backdrop
      ...
      className={mergeUiClassName(
        "fixed inset-0 z-50 bg-black/50 transition-opacity duration-300 data-starting-style:opacity-0 data-ending-style:opacity-0 motion-reduce:transition-none",
        className,
      )}
      {...props}
    />
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={mergeUiClassName(
          cn(
            "bg-background fixed z-50 flex flex-col gap-4 shadow-lg transition-transform ease-in-out duration-500 data-ending-style:duration-300 motion-reduce:transition-none",
            side === "right" &&
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={mergeUiClassName("text-foreground font-semibold", className)}
      {...props}
    />
  );
}
...
function SheetDescription({
  ...
  return (
    <SheetPrimitive.Description
      ...
      className={mergeUiClassName("text-muted-foreground text-sm", className)}
      {...props}
    />
  );
}
