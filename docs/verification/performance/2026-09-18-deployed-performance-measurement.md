...
저장소 루트에서 Node.js 24와 Playwright Chromium을 준비하고 다음 명령으로 같은 측정기를 실행한다. 현재 배포를 재측정하므로 과거 수치가 재현된다고 보장하지 않는다.
...
- [측정 조건과 절차](../../runbooks/docs-deployed-performance-measurement.md)
- [원본 측정값](../artifacts/2026-09-18-deployed-performance.json)
